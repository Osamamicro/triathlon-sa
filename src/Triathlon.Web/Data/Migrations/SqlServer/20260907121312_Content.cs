        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    Category = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ClubId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    InterestEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    LicenceNumber = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    ConsentAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    PreferredCulture = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityEn = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CityAr = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    KindEn = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    KindAr = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabelEn = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    LabelAr = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroImagePath = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleEn = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    TitleAr = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    MetaDescriptionEn = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    MetaDescriptionAr = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    IsPublished = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Variant = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    Anchor = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    EyebrowEn = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    EyebrowAr = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TitleEn = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    TitleAr = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    CtaLabelEn = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CtaLabelAr = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    CtaHref = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    SecondaryLabelEn = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    SecondaryLabelAr = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    SecondaryHref = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),

/* ============================================================
   Saudi Triathlon Federation — public content source.
   Ported from the prototype's assets/js/data.js. Every figure,
   event, document and club the public pages render still comes
   from this file; the dashboard-backed API replaces it in the
   content weeks. All values are illustrative placeholders.
   ============================================================ */
